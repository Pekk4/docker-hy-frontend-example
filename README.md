...
This is a copy of https://github.com/docker-hy/material-applications frontend-example, for testing the project in the [exercise 3.2](https://devopswithdocker.com/part-3/2-deployment-pipelines). This repository will be deleted later.
